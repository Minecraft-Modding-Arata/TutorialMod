package net.arata.tutorialmod.datagen.loot;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        // El cultivo solo suelta la fresa si está en su última etapa, si no suelta la semilla únicamente
        ...
        // No se dropean a sí mismos todos
        this.add(ModBlocks.PINE_SIGN.get(), block ->
                createSingleItemTable(ModItems.PINE_SIGN.get())); // Diría que esto es lo mismo que dropSelf()
    ...
    @Override
    protected Iterable<Block> getKnownBlocks() { // Esto produce un error si hay algún bloque que no tenga el metodo noToolTable que no se haya añadido a generate()
