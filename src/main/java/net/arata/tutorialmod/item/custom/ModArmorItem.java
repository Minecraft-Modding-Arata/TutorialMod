...
import net.arata.tutorialmod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorMaterials.SAPPHIRE, new MobEffectInstance(MobEffects.NIGHT_VISION, 420, 0,
    ...
    // Modificada respecto del tutorial para que quite el efecto inmediatamente cuando se quite la armadura
    @Override
