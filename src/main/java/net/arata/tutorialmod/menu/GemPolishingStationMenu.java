...
import net.arata.tutorialmod.block.entity.GemPolishingStationBlockEntity;
...
public class GemPolishingStationMenu extends AbstractContainerMenu {
    ...
    // Metodo que sirve para que al hacer shift+click se mueva el stack entero correctamente
