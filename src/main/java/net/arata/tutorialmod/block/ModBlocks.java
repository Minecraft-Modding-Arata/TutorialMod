...
public class ModBlocks {
    ...
    // Especifica los bloques a crear
    ...
    // Aquí se utiliza noOcclusion() para no ver a través de los bloques con ellas
    ...
    // Utilizamos las clases de bloque específicas en el RegistryObject para no tener que castearlas en el ModBlockStateProvider
    ...
    // Registra el item del bloque con la clase de los items
